...
public class HierarchicLayoutModule extends LayoutModule
{
    ...
    public void mainrun()
    {
        ...
        hierarchic.setGlobalSequencingActive( op.getBool( GROUPING, ENABLE_GLOBAL_SEQUENCING ) );
                ...
                if ( op.get( GROUP_POLICY ).equals( FIX_GROUPS ) )
                {
                    ...
                    if ( op.get( EDGE_ROUTING ).equals( ORTHOGONAL ) )
                    {
                        fixedGroupLayoutStage
                                .setInterEdgeRoutingStyle( FixedGroupLayoutStage.ROUTING_STYLE_ORTHOGONAL );
                    }
