...
public class OrthogonalLayoutModule extends LayoutModule
{
    ...
    private static final String ROUTE_MULTI_EDGES_IN_PARALLEL = "ROUTE_MULTI_EDGES_IN_PARALLEL";
    ...
    private static final String MINIMUM_SEGMENT_LENGTH = "MINIMUM_SEGMENT_LENGTH";
    ...
    private final String[] styleEnum =
            { NORMAL, NORMAL_TREE, UNIFORM_NODES, BOX_NODES, MIXED, FIXED_MIXED, FIXED_BOX_NODES };
    ...
    public OptionHandler createOptionHandler()
    {
        ...
        op.addBool( ROUTE_MULTI_EDGES_IN_PARALLEL, false );
        op.addDouble( MINIMUM_FIRST_SEGMENT_LENGTH, 10 );
        op.addDouble( MINIMUM_LAST_SEGMENT_LENGTH, 10 );
        op.addDouble( MINIMUM_SEGMENT_LENGTH, 10 );
    ...
    public void mainrun()
    {
        ...
        layoutDescriptor.setMinimumFirstSegmentLength( op.getDouble( MINIMUM_FIRST_SEGMENT_LENGTH ) );
        layoutDescriptor.setMinimumLastSegmentLength( op.getDouble( MINIMUM_LAST_SEGMENT_LENGTH ) );
        layoutDescriptor.setMinimumSegmentLength( op.getDouble( MINIMUM_SEGMENT_LENGTH ) );
        ...
        orthogonal.setParallelEdgeLayouterEnabled( op.getBool( ROUTE_MULTI_EDGES_IN_PARALLEL ) );
        ...
        if ( HierarchyManager.containsGroupNodes( graph ) && !op.get( GROUP_POLICY ).equals( IGNORE_GROUPS ) )
        {
            ...
            else
            {
                ...
                final EdgeLayoutDescriptor descriptor = ogl.getEdgeLayoutDescriptor();
                descriptor.setMinimumFirstSegmentLength( op.getDouble( MINIMUM_FIRST_SEGMENT_LENGTH ) );
                descriptor.setMinimumLastSegmentLength( op.getDouble( MINIMUM_LAST_SEGMENT_LENGTH ) );
                descriptor.setMinimumSegmentLength( op.getDouble( MINIMUM_SEGMENT_LENGTH ) );
                ...
                ogl.setParallelEdgeLayouterEnabled( op.getBool( ROUTE_MULTI_EDGES_IN_PARALLEL ) );
                layouter = ogl;
            }
