...
public class CompactOrthogonalLayoutModule extends LayoutModule
{
    ...
    public OptionHandler createOptionHandler()
    {
        ...
        PartitionLayouter.ComponentPartitionPlacer cpp =
                ( PartitionLayouter.ComponentPartitionPlacer ) layouter.getPartitionPlacer();
        ...
        PartitionLayouter.ChannelInterEdgeRouter cier =
                ( PartitionLayouter.ChannelInterEdgeRouter ) layouter.getInterEdgeRouter();
    ...
    public void mainrun()
    {
        ...
        PartitionLayouter.ChannelInterEdgeRouter router =
                ( PartitionLayouter.ChannelInterEdgeRouter ) compactOrthogonal.getInterEdgeRouter();
        applyOptions( op, router );

        PartitionLayouter.ComponentPartitionPlacer placer =
                ( PartitionLayouter.ComponentPartitionPlacer ) compactOrthogonal.getPartitionPlacer();
