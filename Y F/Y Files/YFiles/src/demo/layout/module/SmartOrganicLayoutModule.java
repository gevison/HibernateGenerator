...
public class SmartOrganicLayoutModule extends LayoutModule
{
    ...
    private static final String USE_AUTOMATIC_GROUP_NODE_COMPACTION = "USE_AUTOMATIC_GROUP_NODE_COMPACTION";

    private static final String GROUP_COMPACTNESS = "GROUP_COMPACTNESS";
    ...
    protected OptionHandler createOptionHandler()
    {
        ...
        cm.setEnabledOnCondition( condition,
                                  op.addDouble( MINIMAL_NODE_DISTANCE, organic.getMinimalNodeDistance(), 0, 100, 0 ) );
        ...
        op.addEnum( RESTRICT_OUTPUT, OUTPUT_RESTRICTIONS, 0 )
        ...
        op.addBool( USE_AUTOMATIC_GROUP_NODE_COMPACTION, organic.isAutomaticGroupNodeCompactionEnabled() );
        op.addDouble( GROUP_COMPACTNESS, organic.getGroupNodeCompactness(), 0, 1 );
        cm.setEnabledOnValueEquals( USE_AUTOMATIC_GROUP_NODE_COMPACTION, Boolean.FALSE, GROUP_COMPACTNESS );
//    op.addDouble(GROUP_NODE_COMPACTNESS, organic.getGroupNodeCompactness(), 0, 1);
    ...
    protected void init()
    {
        ...
        organic.setAutomaticGroupNodeCompactionEnabled( op.getBool( USE_AUTOMATIC_GROUP_NODE_COMPACTION ) );
        organic.setGroupNodeCompactness( op.getDouble( GROUP_COMPACTNESS ) );
