...
public class BusDyer implements GraphListener
{
    ...
    static class Colors
    {
        ...
        private static final Color[] COLORS = { new Color( 0x000000 ), new Color( 0xBF0404 ), new Color( 0x009EFF ),
                                                new Color( 0x1B8C48 ), new Color( 0xB300C2 ), new Color( 0xFF6405 ),
                                                new Color( 0x2B4BFA ), new Color( 0x8C6048 ),
                                                new Color( 0xFAAFE8 ), new Color( 0xB1D95B ), new Color( 0xBBB082 ),
                                                new Color( 0xFAEE00 ), new Color( 0xAAAAAA ),
