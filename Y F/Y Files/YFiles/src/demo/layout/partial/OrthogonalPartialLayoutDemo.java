        ...
        if ( optionHandler != null )
        {
            ...
            partialLayouter.setPositioningStrategy(
                    optionHandler.getBool(
                            "Use Sketch" ) ? PartialLayouter.SUBGRAPH_POSITIONING_STRATEGY_FROM_SKETCH
                                           : PartialLayouter.SUBGRAPH_POSITIONING_STRATEGY_BARYCENTER );
            ...
            switch ( optionHandler.getEnum( "Component Assignment" ) )
            {
                ...
                case 0:
                    partialLayouter
                            .setComponentAssignmentStrategy( PartialLayouter.COMPONENT_ASSIGNMENT_STRATEGY_SINGLE );
                    break;
                case 1:
                    partialLayouter
                            .setComponentAssignmentStrategy( PartialLayouter.COMPONENT_ASSIGNMENT_STRATEGY_CONNECTED );
                    break;
                case 2:
                    partialLayouter
                            .setComponentAssignmentStrategy( PartialLayouter.COMPONENT_ASSIGNMENT_STRATEGY_CUSTOMIZED );
                    break;
            }
