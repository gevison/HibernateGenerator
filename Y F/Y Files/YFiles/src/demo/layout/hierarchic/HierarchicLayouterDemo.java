...
public class HierarchicLayouterDemo extends DemoBase
{
    ...
    class PortSpec extends JPanel
    {
        ...
        Object[] items =
                new Object[]{ "no Group", new Integer( 1 ), new Integer( 2 ), new Integer( 3 ), new Integer( 4 ),
    ...
    void addLabels( EdgeRealizer er )
    {
        ...
        el.setLabelModel( model );
        el.setModelParameter( model.createDiscreteModelParameter( SmartEdgeLabelModel.POSITION_SOURCE_CENTER ) );
        el.setPreferredPlacement( LabelLayoutConstants.PLACE_AT_SOURCE );
        er.addLabel( el );


        el = new EdgeLabel( getTPC( er.getEdge() ).toString() );
        model = new SmartEdgeLabelModel();
        el.setLabelModel( model );
        el.setModelParameter( model.createDiscreteModelParameter( SmartEdgeLabelModel.POSITION_TARGET_CENTER ) );
        ...
        model = new SmartEdgeLabelModel();
        el.setLabelModel( model );
        el.setModelParameter( model.createDiscreteModelParameter( SmartEdgeLabelModel.POSITION_CENTER ) );
