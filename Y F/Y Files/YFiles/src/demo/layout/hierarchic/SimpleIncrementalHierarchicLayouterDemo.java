...
public class SimpleIncrementalHierarchicLayouterDemo extends DemoBase
{
    ...
    public SimpleIncrementalHierarchicLayouterDemo()
    {
        ...
        hierarchicLayouter.getNodeLayoutDescriptor()
                          .setNodeLabelMode( NodeLayoutDescriptor.NODE_LABEL_MODE_CONSIDER_FOR_DRAWING );
    ...
    public void calcIncrementalLayout( NodeCursor incrementalNodes )
    {
        try
        {
            ...
            {
                hintMap.set( incrementalNodes.node(),
                             hintsFactory.createLayerIncrementallyHint( incrementalNodes.node() ) );
            }
