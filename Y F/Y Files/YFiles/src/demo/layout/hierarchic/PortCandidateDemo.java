...
public class PortCandidateDemo extends DemoBase
{
    ...
    public PortCandidateDemo()
    {
        ...
        DragAndDropDemo.DragAndDropSupport dndSupport =
                new DragAndDropDemo.DragAndDropSupport( nodeRealizerList, view );
    ...
    private void addNodeRealizerTemplates( List nodeRealizerList )
    {
        ...
        }
        {
            ...
            candidateSet
                    .add( PortCandidate.createCandidate( 0.0, -15.0, PortCandidate.NORTH, 1.0 ), Integer.MAX_VALUE );
            candidateSet
                    .add( PortCandidate.createCandidate( 0.0, +15.0, PortCandidate.SOUTH, 1.0 ), Integer.MAX_VALUE );
        ...
        }
        {
            ...
            PortCandidateSet candidateSet = new PortCandidateSet();
            candidateSet
                    .add( PortCandidate.createCandidate( 0.0, -15.0, PortCandidate.NORTH, 0.0 ), Integer.MAX_VALUE );
            candidateSet.add( PortCandidate.createCandidate( 0.0, +15.0, PortCandidate.SOUTH, 0.0 ), 1 );
    ...
    void addNodeRealizerTemplate( String configuration, List nodeRealizerList, PortCandidateSet candidateSet )
    {
        ...
        map.put( Painter.class, new PortCandidatePainter(
                ( Painter ) factory.getImplementation( DemoDefaults.NODE_CONFIGURATION, Painter.class ),
                candidateSet ) );
