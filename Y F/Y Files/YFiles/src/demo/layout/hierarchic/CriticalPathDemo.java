...
public class CriticalPathDemo extends DemoBase
{
    ...
    public CriticalPathDemo( final String helpFilePath )
    {
        final JSplitPane splitPane =
                new JSplitPane( JSplitPane.HORIZONTAL_SPLIT, createOptionTable( createOptionHandler() ),
                                view );
    ...
    protected OptionHandler createOptionHandler()
    {
        ...
        OptionItem minimalLayerDistanceItem =
                layoutOptionHandler.addInt( "Minimal Layer Distance", minimalLayerDistance );
        ...
        OptionItem useOrthogonalEdgeRoutesItem =
                layoutOptionHandler.addBool( "Use Orthogonal Edge Routes", useOrthogonalEdgeRoutes );
        ...
        OptionItem backloopRoutingEnabledItem =
                layoutOptionHandler.addBool( "Enable Backloop Routing", backloopRoutingEnabled );
        ...
        OptionItem edgeStraighteningOptimizationEnabledItem =
                layoutOptionHandler.addBool( "Enable Edge Straightening", edgeStraighteningOptimizationEnabled );
    ...
    private Layouter getHierarchicLayouter()
    {
        ...
        {
            ( ( SimplexNodePlacer ) layouter.getNodePlacer() )
                    .setEdgeStraighteningOptimizationEnabled( edgeStraighteningOptimizationEnabled );
        }
