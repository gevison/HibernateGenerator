...
public class IncrementalTreeLayouterDemo extends DemoBase
{
...

    {
        ...
        layerStyles.add( new DefaultNodePlacer( DefaultNodePlacer.PLACEMENT_HORIZONTAL_DOWNWARD,
                                                DefaultNodePlacer.ALIGNMENT_LEADING_OFFSET,
                                                DefaultNodePlacer.ROUTING_FORK_AT_ROOT, 10.0, 20.0 ) );
        layerStyles.add( new DefaultNodePlacer( DefaultNodePlacer.PLACEMENT_HORIZONTAL_DOWNWARD,
                                                DefaultNodePlacer.ALIGNMENT_MEDIAN, 40.0, 40.0 ) );
    }
    ...
    public IncrementalTreeLayouterDemo()
    {
        ...
        spinner.addChangeListener( new ChangeListener()
        {
            public void stateChanged( ChangeEvent ce )
            {
                ...
                {
                    layerStyles.add( new DefaultNodePlacer( DefaultNodePlacer.PLACEMENT_HORIZONTAL_DOWNWARD, 40.0,
                                                            40.0 ) );
                }
    ...
    final class TreeCreateChildEdgeMode extends CreateChildEdgeMode
    {
        ...
        private void parseNodePlacement( Graph2D g, Edge e, EdgeRealizer er )
        {
            ...
            nodePlacerMap
                    .set( e.source(), new DefaultNodePlacer( placement, alignment, routing, hDistance, vDistance ) );
        }
    ...
    final class TreeLayouterPopupMode extends PopupMode
    {
        ...
        TreeLayouterPopupMode()
        {
            ...
            placement.add( new PlacementAction( "Horizontally Downwards",
                                                DefaultNodePlacer.PLACEMENT_HORIZONTAL_DOWNWARD ) );
            placement.add( new PlacementAction( "Horizontally Upwards",
                                                DefaultNodePlacer.PLACEMENT_HORIZONTAL_UPWARD ) );
            placement.add( new PlacementAction( "Vertically to Left", DefaultNodePlacer.PLACEMENT_VERTICAL_TO_LEFT ) );
            placement
                    .add( new PlacementAction( "Vertically to right", DefaultNodePlacer.PLACEMENT_VERTICAL_TO_RIGHT ) );
    ...
    final class PlacementAction extends AssignLayouterAction
    {
        ...
        protected NodePlacer getPlacer( NodePlacer placer )
        {
            ...
            {
                placer =
                        new DefaultNodePlacer( newPlacement, DefaultNodePlacer.ALIGNMENT_MEDIAN, hDistance, vDistance );
            }
            return placer;
        }
    }
    ...
    final class AlignmentAction extends AssignLayouterAction
    {
        ...
        protected NodePlacer getPlacer( NodePlacer placer )
        {
            ...
            {
                placer =
                        new DefaultNodePlacer( DefaultNodePlacer.PLACEMENT_HORIZONTAL_DOWNWARD, newAlignment, hDistance,
                                               vDistance );
            }
            return placer;
        }
