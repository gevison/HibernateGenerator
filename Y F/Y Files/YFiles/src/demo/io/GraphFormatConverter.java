...
public class GraphFormatConverter
{
    ...
    public GraphFormatConverter()
    {
        ...
        try
        { //try to support SVG(Z) output format if it is present
        ...
        try
        { //try to support PDF output format if it is present
        ...
        try
        { //try to support SWF output format if it is present
        ...
        try
        { //try to support EPS output format if it is present
        ...
        try
        { //try to support EMF output format if it is present
