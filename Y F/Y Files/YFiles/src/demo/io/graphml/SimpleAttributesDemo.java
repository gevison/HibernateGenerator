...
public class SimpleAttributesDemo extends GraphMLDemo
{
    ...
    protected GraphMLIOHandler createGraphMLIOHandler()
    {
        ...
        ioHandler.getGraphMLHandler()
                 .addInputDataAcceptor( "BooleanValue", node2BoolMap, KeyScope.NODE, KeyType.BOOLEAN );
        ioHandler.getGraphMLHandler()
                 .addOutputDataProvider( "BooleanValue", node2BoolMap, KeyScope.NODE, KeyType.BOOLEAN );
