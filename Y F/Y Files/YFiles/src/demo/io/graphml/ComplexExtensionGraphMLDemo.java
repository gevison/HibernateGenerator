...
public class ComplexExtensionGraphMLDemo extends GraphMLDemo
{
    ...
    {
        public void serializeItem( Object o, XmlWriter writer, GraphMLWriteContext context )
                throws GraphMLWriteException
        {
            Item item = ( Item ) o;
    ...
    {
        public Object deserializeNode( org.w3c.dom.Node xmlNode, GraphMLParseContext context )
    ...
    {
        protected Object parseDataCore( GraphMLParseContext context, org.w3c.dom.Node node )
                throws GraphMLParseException
        {
