...
public class OrgChartDemo
{
    ...
    private void addGlassPaneComponents( JOrgChart orgChart )
    {
        ...
        zoomIn.putValue( AbstractAction.SMALL_ICON,
                         new ImageIcon( getClass().getResource( "resources/icons/zoomIn.png" ) ) );
        ...
        zoomOut.putValue( AbstractAction.SMALL_ICON,
                          new ImageIcon( getClass().getResource( "resources/icons/zoomOut.png" ) ) );
        ...
        fitContent.putValue( AbstractAction.SMALL_ICON,
                             new ImageIcon( getClass().getResource( "resources/icons/zoomFit.png" ) ) );
