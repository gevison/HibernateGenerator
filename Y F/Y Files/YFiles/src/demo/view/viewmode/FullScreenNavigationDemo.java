...
public class FullScreenNavigationDemo extends DemoBase
{
    ...
    private NavigationComponent createNavigationComponent( Graph2DView view, double scrollStepSize,
                                                           int scrollTimerDelay )
    {
        ...
        MouseAdapter navigationToolListener = new MouseAdapter()
        {
            public void mouseEntered( MouseEvent e )
            {
                ...
                navigation.setBackground(
                        new Color( background.getRed(), background.getGreen(), background.getBlue(), 196 ) );
            }
    ...
    class FullScreenAction extends AbstractAction
    {
        ...
        private void addGlassPaneComponents()
        {
            ...
            NavigationComponent navigationComponent =
                    createNavigationComponent( view, scrollStepSize, scrollTimerDelay );
            ...
            navigationComponent.setPreferredSize(
                    new Dimension( ( int ) navigationComponent.getPreferredSize().getWidth(), 300 ) );
        ...
        private JPanel createInnerToolbar( final Overview overview, final NavigationComponent navigationComponent )
        {
            ...
            final JToggleButton navigateButton =
                    new JToggleButton( new ToggleComponentVisibilityAction( navigationComponent ) );
