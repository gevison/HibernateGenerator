...
public class SmartLabelModelDemo extends DemoBase
{
    ...
    protected void configureDefaultRealizers()
    {
        ...
        edgeLabel.setModelParameter(
                edgeLabelModel.createDiscreteModelParameter( SmartEdgeLabelModel.POSITION_CENTER ) );
        ...
        public JPopupMenu getNodePopup( final Node node )
        {
            ...
            pm.add( new AbstractAction( "Add Label" )
            {
                public void actionPerformed( ActionEvent e )
                {
                    ...
                    label.setLabelModel( nodeLabelModel );
                    label.setModelParameter( nodeLabelModel.getDefaultParameter() );
