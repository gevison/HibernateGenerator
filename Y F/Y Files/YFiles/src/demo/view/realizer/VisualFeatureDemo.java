 ...
 * disappear, if the shift key is pressed down. Then the placement of labels at arbitrary positions is possible.
 * <p/>
...
public class VisualFeatureDemo extends DemoBase
{
    ...
    public VisualFeatureDemo()
    {
        ...
        double bendStartEndY = ( quadCurveEdgeRealizer.getSourceIntersection().getY() +
                                         quadCurveEdgeRealizer.getTargetIntersection().getY() ) / 2;
        Bend lastBend = null;
        ...
        final Object newParam =
                edge13_14Label.getBestModelParameterForBounds( labelBounds.getMovedInstance( -80, 40 ) );
