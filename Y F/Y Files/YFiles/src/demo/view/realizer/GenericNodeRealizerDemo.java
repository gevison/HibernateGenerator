...
//    configNames.add(configName);
    ...
    private Map createRoundRectConfiguration( GenericNodeRealizer.Factory factory )
    {
        ...
        RectangularShapePainter painter =
                new RectangularShapePainter( new RoundRectangle2D.Double( 50, 50, 50, 50, 15, 15 ) );
...
//    implementationsMap.put(GenericNodeRealizer.Painter.class, new ShadowNodePainter(painter));
     ...
     */
    public static final class RectangularShapePainter extends AbstractCustomNodePainter implements
    ...
    static class FlatButtonPainter extends AbstractCustomNodePainter
    {
        ...
        private void paintContent( Graphics2D g, Shape shape, Color c1, int thick, double x, double y, double w,
                                   double h )
        {
            ...
            {
                g.setPaint( new GradientPaint( ( float ) x, ( float ) ( y - 5 ), new Color( 1.0f, 1.0f, 1.0f, 0.3f ),
                                               ( float ) x,
            ...
            g.fill(
                    new Rectangle2D.Double( x - thick - thick, y - thick, w + thick + thick + thick + thick,
                                            h + thick + thick ) );
        ...
        private Color mixColors( Color c1, Color c2, float ratio )
        {
            ...
            return new Color( ( c1.getRed() * ratio + c2.getRed() * b ) / 255f,
                              ...
                              ( c1.getBlue() * ratio + c2.getGreen() * b ) / 255f,
                              ( c1.getAlpha() * ratio + c2.getAlpha() * b ) / 255f );
        }
    }
