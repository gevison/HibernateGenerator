...
public class SwingRendererDemo extends DemoBase
{
    ...
    public SwingRendererDemo()
    {
        ...
        map.put( GenericNodeRealizer.Painter.class,
                 new NodeCellRendererPainter( simpleNodeCellRenderer, NodeCellRendererPainter.USER_DATA_MAP ) );
        map.put( GenericNodeRealizer.UserDataHandler.class,
        ...
        map.put( GenericNodeRealizer.Painter.class,
                 new NodeCellRendererPainter( new ComplexNodeCellRenderer(), NodeCellRendererPainter.USER_DATA_MAP ) );
        // register it
    ...
    protected void registerViewModes()
    {
        ...
        CellEditorMode cellEditorMode =
                new CellEditorMode( nodeCellEditorProvider, NodeCellRendererPainter.USER_DATA_MAP );
    ...
    public static class SimpleNodeCellEditor extends AbstractCellEditor implements NodeCellEditor
    {
        ...
        public JComponent getNodeCellEditorComponent( Graph2DView view, NodeRealizer context, Object value,
                                                      boolean isSelected )
        {
