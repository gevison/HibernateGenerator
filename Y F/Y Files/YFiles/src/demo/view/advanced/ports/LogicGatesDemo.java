...
public class LogicGatesDemo extends DemoBase
{
    ...
    protected void initialize()
    {
        ...
        DragAndDropDemo.DragAndDropSupport dragAndDropSupport =
                new DragAndDropDemo.DragAndDropSupport( logicSymbols, view );
    ...
    private void initializePortConfiguration()
    {
        ...
        portImpls.put( NodePort.BoundsProvider.class, new NodePort.BoundsProvider()
        {
            ...
            private LogicGateConfiguration getLogicGateHandler( NodePort port )
            {
                ...
                return ( LogicGateConfiguration ) factory
                        .getImplementation( configuration, GenericNodeRealizer.ContainsTest.class );
            }
        } );
        ...
        portImpls.put( NodePort.Painter.class, new NodePort.Painter()
        {
            public void paint( NodePort port, Graphics2D gfx )
            {
                ...
                gfx.draw( new Line2D.Double( bounds.getX(), bounds.getY(), bounds.getX() + bounds.getWidth(),
                                             bounds.getY() ) );
            }
        } );
    ...
    protected EditMode createEditMode()
    {
        ...
        final MovePortMode mpm = new MovePortMode()
        {
                                              ...
                                              boolean isSnapCandidate )
            {
                ...
                {
                    HitInfo info =
                            view.getHitInfoFactory().createHitInfo( p.x, p.y, Graph2DTraversal.NODE_PORTS, true );
    ...
    private static final class PortHighlightDrawable implements Drawable
    {
        ...
        public Rectangle getBounds()
        {
            ...
            return new Rectangle( ( int ) rect.getX(), ( int ) rect.getY(), ( int ) rect.getWidth(),
                                  ( int ) rect.getHeight() );
        }
    }
