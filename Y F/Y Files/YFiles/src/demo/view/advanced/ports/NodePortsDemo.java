...
public class NodePortsDemo extends GroupingDemo
{
    ...
    protected JToolBar createToolBar()
    {
        ...
        final Action toggleFixedPortsAction = new AbstractAction( "Fixed Ports" )
        {
            public void actionPerformed( final ActionEvent e )
            {
        ...
        toggleFixedPortsAction.putValue( Action.SHORT_DESCRIPTION,
                                         "Toggle the 'Fixed Ports' feature of the layout algorithms" );

        final Action toggleGroupEdgesAction = new AbstractAction( "Edge Grouping" )
        {
            public void actionPerformed( final ActionEvent e )
            {
        ...
        toggleGroupEdgesAction.putValue( Action.SHORT_DESCRIPTION,
                                         "Toggle the 'Automatic Edge Grouping' feature of the layout algorithms" );
        ...
        jtb.add( new JToggleButton( toggleFixedPortsAction ) );
        jtb.addSeparator( TOOLBAR_SMALL_SEPARATOR );
        jtb.add( new JToggleButton( toggleGroupEdgesAction ) );
