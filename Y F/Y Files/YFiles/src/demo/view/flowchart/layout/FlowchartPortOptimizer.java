...
class FlowchartPortOptimizer extends AbstractPortConstraintOptimizer
{
    ...
    public void optimizeAfterLayering( LayoutGraph graph, Layers layers, LayoutDataProvider ldp,
    ...
    protected void optimizeAfterSequencing( Node node, Comparator inEdgeOrder, Comparator outEdgeOrder,
                                            LayoutGraph graph,
                                            LayoutDataProvider ldp, ItemFactory itemFactory )
    {
        ...
        for ( EdgeCursor ec = node.edges(); ec.ok(); ec.next() )
        {
            ...
            if ( isTemporarySameLayerEdge( edge, ldp ) )
            {
                ...
                itemFactory.setTemporaryPortConstraint( edge, node.equals( edge.source() ),
...
//    }
    ...
    static class SameLayerNodePositionComparator implements Comparator
    {
        ...
        public int compare( Object o1, Object o2 )
        {
            return Comparators.compare( ldp.getNodeData( ( Node ) o1 ).getPosition(),
                                        ldp.getNodeData( ( Node ) o2 ).getPosition() );
        }
    }
