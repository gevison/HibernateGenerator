...
public class FlowchartLayoutModule extends LayoutModule
{
    ...
    {
        super( FLOWCHART_LAYOUT, "yFiles Layout Team", "Flowchart Layout" );
    ...
    {
        final OptionHandler op = new OptionHandler( getModuleName() );
        ...
        op.addBool( ALLOW_FLATWISE_EDGES, false );
    ...
    protected void mainrun()
    {
        ...
        configureLayoutExecutor( layouter );
     ...
     */
    private void configureLayoutExecutor( FlowchartLayouter layouter )
    {
        ...
        final TableLayoutConfigurator tableLayoutConfigurator = getLayoutExecutor().getTableLayoutConfigurator();
        tableLayoutConfigurator.setHorizontalLayoutConfiguration( isHorizontalOrientation( layouter ) );
        tableLayoutConfigurator.setTableToTableDistance( layouter.getMinimumPoolDistance() );
        tableLayoutConfigurator.setFromSketchModeEnabled( true );
    }
