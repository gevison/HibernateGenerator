...
public class FlowchartDisplayPainter extends AbstractFlowchartPainter
{
    ...
    protected void updateOutline( NodeRealizer context )
    {
        ...
        shapePath.quadTo( ( float ) ( x + borderDistance ), ( float ) ( y + borderDistance ),
                          ( float ) ( x + 4 * borderDistance ), ( float ) y );
        ...
        shapePath.quadTo( ( float ) ( x + borderDistance ), ( float ) ( y + height - borderDistance ), ( float ) x,
                          ( float ) ( y + height / 2 ) );
    }
}
