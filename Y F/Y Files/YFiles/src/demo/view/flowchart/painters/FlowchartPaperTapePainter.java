...
public class FlowchartPaperTapePainter extends AbstractFlowchartPainter
{
    ...
    protected void updateOutline( NodeRealizer context )
    {
        ...
        shapePath.quadTo( ( float ) ( x + 0.25 * width ), ( float ) ( y + 3 * borderDistance ),
                          ( float ) ( x + 0.5 * width ), ( float ) ( y + borderDistance ) );
        shapePath.quadTo( ( float ) ( x + 0.75 * width ), ( float ) ( y - borderDistance ), ( float ) ( x + width ),
                          ( float ) ( y + borderDistance ) );
        shapePath.lineTo( ( float ) ( x + width ), ( float ) ( y + height - borderDistance ) );
        shapePath.quadTo( ( float ) ( x + 0.75 * width ), ( float ) ( y + height - 3 * borderDistance ),
                          ( float ) ( x + 0.5 * width ), ( float ) ( y + height - borderDistance ) );
