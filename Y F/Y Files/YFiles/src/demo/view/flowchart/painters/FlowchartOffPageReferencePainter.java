...
public class FlowchartOffPageReferencePainter extends AbstractFlowchartPainter
{
    ...
    protected void updateOutline( NodeRealizer context )
    {
        ...
        shape.lineTo( ( float ) ( x + minLength + borderDistanceX ),
                      ( float ) ( y + minLength / 2 + borderDistanceY ) );
        shape.lineTo( ( float ) ( x + minLength / 2 + borderDistanceX ),
                      ( float ) ( y + minLength + borderDistanceY ) );
