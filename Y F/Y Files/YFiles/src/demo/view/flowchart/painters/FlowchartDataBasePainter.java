...
public class FlowchartDataBasePainter extends AbstractFlowchartPainter
{
    ...
    protected void updateOutline( NodeRealizer context )
    {
        ...
        shapePath.curveTo( ( float ) ( x + X_OFFSET_1 * width ), ( float ) y,
                           ( float ) ( x + width - X_OFFSET_1 * width ), ( float ) y, ( float ) ( x + width ),
                           ( float ) ( y + Y_OFFSET_1 * height ) );
        shapePath.lineTo( ( float ) ( x + width ), ( float ) ( y + height - Y_OFFSET_1 * height ) );
        shapePath.curveTo( ( float ) ( x + width - X_OFFSET_1 * width ), ( float ) ( y + height ),
                           ( float ) ( x + X_OFFSET_1 * width ), ( float ) ( y + height ), ( float ) x,
                           ( float ) ( y + height - Y_OFFSET_1 * height ) );
        shapePath.closePath();
    }
    ...
    public void updateInsideShape( NodeRealizer context )
    {
        ...
        shapePath.curveTo( ( float ) ( x + width - X_OFFSET_1 * width ), ( float ) ( y + 2 * Y_OFFSET_1 * height ),
                           ( float ) ( x + X_OFFSET_1 * width ), ( float ) ( y + 2 * Y_OFFSET_1 * height ), ( float ) x,
                           ( float ) ( y + Y_OFFSET_1 * height ) );
    }
