...
public class FlowchartPalette extends JComponent
{
    ...
    protected void addDefaultTemplates( final List realizers )
    {
        ...
        realizers.add( FlowchartRealizerFactory
                               .createAnnotation( FlowchartAnnotationPainter.PROPERTY_ORIENTATION_VALUE_AUTO ) );
    ...
    private static final class DragAndDropSupport
    {
                                                           ...
                                                           new DragGestureListener()
                                                           {
                                                                       ...
                                                                       DragGestureEvent event )
                                                               {
                                                                   ...
                                                                   if ( value instanceof NodeRealizer )
                                                                   {
                                                                       ...
                                                                       dropSupport.startDrag( dragSource, nr, event,
        ...
        public void configureSnapping( final boolean snapping, final int nodeToNodeDistance,
                                       final int nodeToEdgeDistance,
